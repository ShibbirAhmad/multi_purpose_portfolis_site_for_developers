        ...
        <div class="grid_12">
            <ul class="nav main">
                ...
                <?php 
                       ...
                       $notification=$subscriber->getUnapprovedSubscriber(); 

                       if($notification){ 
                                $i=0;
                       while($show=$notification->fetch_assoc()){ 
                          $i++ ;
                ?>
				<li class="ic-grid-tables"><a href="inbox.php"><span>Inbox<-<?php echo $i; ?>-></span></a></li>
                    <?php  } } ?>
